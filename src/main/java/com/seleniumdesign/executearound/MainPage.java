...
public class MainPage {
  ...
  public void onFrameA(Consumer<FrameA> frameAConsumer) {
    this.driver.switchTo().frame(a);
    frameAConsumer.accept(this.frameA);
    this.driver.switchTo().defaultContent();
  }

  public void onFrameB(Consumer<FrameB> frameBConsumer) {
    this.driver.switchTo().frame(b);
    frameBConsumer.accept(this.frameB);
    this.driver.switchTo().defaultContent();
  }

  public void onFrameC(Consumer<FrameC> frameCConsumer) {
    this.driver.switchTo().frame(c);
    frameCConsumer.accept(this.frameC);
    this.driver.switchTo().defaultContent();
  }
}
